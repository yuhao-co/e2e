 ...
 * EN Source commits: 40a950a2f6 by Shen Qiutong: [FEATURE][FLIGHT]: debug tool (#33441)
 * 中文来源提交: 40a950a2f6 by Shen Qiutong: [FEATURE][FLIGHT]: debug tool (#33441)
 * EN Source summary: PRD: https://traveloka.sg.larksuite.com/wiki/Soe8wLdE8iHLW9kPCt9lfPF8gAb | Apply all locator rules from docs/traveloka-flight-locator-guideline.md | Validate filter structure per docs/traveloka-flight-filter-structure.md | Check carry-over behavior per docs/traveloka-flight-carry-over-airline-bug-report.md | ⭐ Run P0 critical bug detection (flight flows) - powered by config/p0-detection-rules.json | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active
 * 中文来源摘要: PRD: https://traveloka.sg.larksuite.com/wiki/Soe8wLdE8iHLW9kPCt9lfPF8gAb | Apply all locator rules from docs/traveloka-flight-locator-guideline.md | Validate filter structure per docs/traveloka-flight-filter-structure.md | Check carry-over behavior per docs/traveloka-flight-carry-over-airline-bug-report.md | ⭐ Run P0 critical bug detection (flight flows) - powered by config/p0-detection-rules.json | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active
...
test('Traveloka weekly diff generated flight results coverage (20260605)', async ({ page, ai, aiQuery }, testInfo) => {
