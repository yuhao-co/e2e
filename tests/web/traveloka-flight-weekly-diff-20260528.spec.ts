...
const ROUTED_SOURCE_FILES = [
  "packages/flight/fpr-search-result-ssr-components/.storybook/preview.js",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailCell.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailCell.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.stylex.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailSection.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailSegmentHeader.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailSegmentHeader.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/constants.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/flightDetailContentStoryFrame.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/helpers.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/types.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/LineProgress/LineProgress.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/LineProgress/LineProgress.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/LineProgress/types.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/LoadingState/LoadingState.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/LoadingState/LoadingState.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/LoadingState/types.ts",
  "packages/flight/fpr-search-result-ssr-components/desktop/RoundTripBanner/RoundTripBanner.story.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/RoundTripBanner/RoundTripBanner.tsx",
  "packages/flight/fpr-search-result-ssr-components/desktop/RoundTripBanner/types.ts",
  ...
  "packages/flight/fpr-search-result-v2/components/MobileFilterSorts/MobileFilters.tsx",
  "packages/flight/fpr-search-result-v2/components/SearchResultList/FlightSectionList.tsx",
  "packages/flight/fpr-search-result-v2/containers/MwebContentHolder.tsx"
];
 ...
 * EN Source commits: bafa6cb617 by Randi Adiel Gianufian: [FEATURE][FLIGHT][WEB] SSR - flight segments (#33403) | 3e86436401 by Randi Adiel Gianufian: [FEATURE][FLIGHT][WEB] SSR - loading and rtbanner (#33497) | d076923a9c by Randi Adiel Gianufian: [FEATURE][FLIGHT][D-WEB] SSR - transit route (#33520)
 * 中文来源提交: bafa6cb617 by Randi Adiel Gianufian: [FEATURE][FLIGHT][WEB] SSR - flight segments (#33403) | 3e86436401 by Randi Adiel Gianufian: [FEATURE][FLIGHT][WEB] SSR - loading and rtbanner (#33497) | d076923a9c by Randi Adiel Gianufian: [FEATURE][FLIGHT][D-WEB] SSR - transit route (#33520)
...
test('Traveloka weekly diff generated flight results coverage (20260528)', async ({ page, ai, aiQuery }, testInfo) => {
  ...
  // EN PRD: https://project.larksuite.com/fpr/epic/detail/11760659
// EN PRD: https://project.larksuite.com/fpr/epic/detail/11760659
  try {
...
// EN PRD: https://project.larksuite.com/fpr/epic/detail/11760659
  ...
  // Suggested changed files (top 10 of 35): ["packages/flight/fpr-search-result-v2/components/FlightSearchSidebar/FlightSearchSidebarFilter.tsx","packages/flight/fpr-search-result-ssr-components/.storybook/preview.js","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/constants.ts","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailCell.story.tsx","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailCell.tsx","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.story.tsx","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.stylex.ts","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailContent.tsx","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/flightDetailContentStoryFrame.tsx","packages/flight/fpr-search-result-ssr-components/desktop/FlightDetailContent/FlightDetailSection.tsx"]
  // Omitted additional changed files: 25
