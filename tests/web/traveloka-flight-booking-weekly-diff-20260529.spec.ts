...
const ROUTED_SOURCE_FILES = [
  "packages/flight/fpr-booking/__tests__/components/handlers/bookingContactValidationHandler.test.ts",
  "packages/flight/fpr-booking/components/BFFBookingContact/BFFBookingContactDesktop.tsx",
  "packages/flight/fpr-booking/components/BFFBookingContact/BFFBookingContactMobile.tsx",
  "packages/flight/fpr-booking/components/BFFBookingContact/BFFBookingContactMobile2.tsx",
  "packages/flight/fpr-booking/components/BFFBookingContact/BFFBookingContactMobileVDTray.tsx",
  "packages/flight/fpr-booking/components/BFFBookingContact/__tests__/BFFBookingContactMobile2.test.js",
  "packages/flight/fpr-booking/components/BFFBookingContact/_usecases/__tests__/useBookingContactLoginSignupNudge.test.ts",
  "packages/flight/fpr-booking/components/BFFBookingContact/_usecases/useBookingContactLoginSignupNudge.ts",
  "packages/flight/fpr-booking/components/handlers/bookingContactValidationHandler.ts",
  "packages/flight/fpr-booking/__tests__/components/AddOns/PreselectedAddons/PreselectedAddons.test.tsx"
];
...
const GENERATED_ACTION_CONTRACTS = [
  ...
  {
    "stepName": "booking-chain-view_fsv2_ticket_option_card_0",
 ...
 * EN Action booking-chain-view_fsv2_ticket_option_card_0: scope=Ticket type selection overlay after choosing a flight; contracts=[data-testid="view_fsv2_ticket_option_card_0"] | [data-testid="button_fsv2_ticket_option_select_0"]; confidence=high
 ...
 * 中文动作 booking-chain-view_fsv2_ticket_option_card_0: 范围=Ticket type selection overlay after choosing a flight；契约=[data-testid="view_fsv2_ticket_option_card_0"] | [data-testid="button_fsv2_ticket_option_select_0"]；置信度=high
...
test('Traveloka weekly diff booking smoke coverage (20260529)', async ({ page, ai, aiQuery }, testInfo) => {
