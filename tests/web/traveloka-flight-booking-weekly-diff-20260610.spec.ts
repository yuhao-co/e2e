...
const ROUTED_SOURCE_FILES = [
  ...
  "packages/accom/acd-booking-platform/components-mobile/index.ts"
];
...
test('Traveloka weekly diff booking smoke coverage (20260610)', async ({ page, ai, aiQuery }, testInfo) => {
