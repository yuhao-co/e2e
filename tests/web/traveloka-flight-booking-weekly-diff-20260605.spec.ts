 ...
 * EN Source commits: fb0594cdbb by yuhao-co: [FEATURE] feat: Implement sticky save button functionality and revamp traveler UI (#33346) | 94ffd88e83 by Rafi Raihansyah: [FEATURE][ACCOM] SBF Booking Simplify (Upfornt) (#33141)
 * 中文来源提交: fb0594cdbb by yuhao-co: [FEATURE] feat: Implement sticky save button functionality and revamp traveler UI (#33346) | 94ffd88e83 by Rafi Raihansyah: [FEATURE][ACCOM] SBF Booking Simplify (Upfornt) (#33141)
...
test('Traveloka weekly diff booking smoke coverage (20260605)', async ({ page, ai, aiQuery }, testInfo) => {
