...
test('Traveloka weekly diff generated flight results coverage (20260603)', async ({ page, ai, aiQuery }, testInfo) => {
  ...
  // Suggested changed files (top 10 of 13): ["packages/flight/fpr-search-result-v2/components/FlightItem/FlightItem.tsx","packages/flight/fpr-search-result-v2/components/MobileNavbar/MobileNavbar.tsx","packages/flight/fpr-search-result-v2/components/MobileSearchResultList/MobileFlightSearchResultItem.tsx","packages/flight/fpr-search-result-v2/package.json","packages/flight/fpr-search-result-v2/providers/SearchResultFetchProvider.tsx","packages/flight/fpr-search-result-components/src/FlightCard/RoundTripAPI/FlightCard.tsx","packages/flight/app-desktop/pages/flight/fullsearch.tsx","packages/flight/app-desktop/pages/flight/fulltwosearch.tsx","packages/flight/app-mobile/pages/flight/fullsearch.tsx","packages/flight/app-mobile/pages/flight/fulltwosearch.tsx"]
  // Omitted additional changed files: 3
