...
const ROUTED_SOURCE_FILES = [
  "packages/flight/fpr-booking/__tests__/containers/BFFDynamicComponent.test.tsx",
  "packages/flight/fpr-booking/components/BFFTravelerDetail/_usecases/__tests__/useTravelerDetailAction.test.ts",
  "packages/flight/fpr-booking/components/BFFTravelerDetail/_usecases/useTravelerDetailAction.ts",
  "packages/accom/acd-booking-platform/__tests__/components-mobile/GuestNameInput.test.tsx",
  "packages/accom/acd-booking-platform/__tests__/components-mobile/HotelGuestDetailUpfront.test.tsx",
  "packages/accom/acd-booking-platform/__tests__/util/BookingSpec.test.tsx",
  "packages/accom/acd-booking-platform/__tests__/util/desktopTracking.test.tsx",
  "packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/GuestNameInput.tsx",
  "packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/HotelGuestDetailUpfront.tsx",
  "packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/types.ts"
];
...
/**
 * EN Purpose: Open the desktop Traveloka flight booking flow from search results, preserve the canonical booking => payment chain contracts, and verify payment-selection, credit-card setup, and pay-CTA behavior for the routed weekly regression slice.
 ...
 * EN Source commits: 94ffd88e83 by Rafi Raihansyah: [FEATURE][ACCOM] SBF Booking Simplify (Upfornt) (#33141)
 * 中文来源提交: 94ffd88e83 by Rafi Raihansyah: [FEATURE][ACCOM] SBF Booking Simplify (Upfornt) (#33141)
 * EN Source summary: Referencing https://github.com/traveloka/www/pull/33029 for Booking's Contact Detail implementation | canonical desktop booking entry chain remains reachable | complete Choose→Select booking chain execution required | booking page URL is reached and contact form renders correctly | Apply booking contracts from docs/traveloka-flight-booking-case-generation.md | Apply locked booking=>payment contracts from docs/traveloka-flight-booking-payment-chain-lock.md | When payment is in scope, treat credit-card fields as iframe-scoped and paymentPayButton as main-page CTA | Apply locator rules from docs/traveloka-flight-locator-guideline.md (Prefer explicit contracts) | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active | Reference: docs/PHASE2_WORKFLOW_INTEGRATION_SUMMARY.md
 * 中文来源摘要: Referencing https://github.com/traveloka/www/pull/33029 for Booking's Contact Detail implementation | canonical desktop booking entry chain remains reachable | complete Choose→Select booking chain execution required | booking page URL is reached and contact form renders correctly | Apply booking contracts from docs/traveloka-flight-booking-case-generation.md | Apply locked booking=>payment contracts from docs/traveloka-flight-booking-payment-chain-lock.md | When payment is in scope, treat credit-card fields as iframe-scoped and paymentPayButton as main-page CTA | Apply locator rules from docs/traveloka-flight-locator-guideline.md (Prefer explicit contracts) | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active | Reference: docs/PHASE2_WORKFLOW_INTEGRATION_SUMMARY.md
...
test('Traveloka weekly diff booking smoke coverage (20260611)', async ({ page, ai, aiQuery }, testInfo) => {
  ...
  const workflowPlan = createFlightWorkflowPlan({
    url: TARGET_URL,
    userIntent: "Open the desktop Traveloka flight booking flow from search results, preserve the canonical booking => payment chain contracts, and verify payment-selection, credit-card setup, and pay-CTA behavior for the routed weekly regression slice.",
  ...
  // Suggested changed files (top 10 of 51): ["packages/flight/fpr-booking/__tests__/containers/BFFDynamicComponent.test.tsx","packages/flight/fpr-booking/components/BFFTravelerDetail/_usecases/__tests__/useTravelerDetailAction.test.ts","packages/flight/fpr-booking/components/BFFTravelerDetail/_usecases/useTravelerDetailAction.ts","packages/accom/acd-booking-platform/__tests__/components-mobile/GuestNameInput.test.tsx","packages/accom/acd-booking-platform/__tests__/components-mobile/HotelGuestDetailUpfront.test.tsx","packages/accom/acd-booking-platform/__tests__/util/BookingSpec.test.tsx","packages/accom/acd-booking-platform/__tests__/util/desktopTracking.test.tsx","packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/GuestNameInput.tsx","packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/HotelGuestDetailUpfront.tsx","packages/accom/acd-booking-platform/components-mobile/GuestDetailUpfrontV2/types.ts"]
  // Omitted additional changed files: 41
