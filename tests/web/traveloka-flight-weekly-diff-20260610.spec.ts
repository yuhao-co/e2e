...
const ROUTED_SOURCE_FILES = [
  ...
  "packages/flight/fpr-search-result-components/package.json",
  "packages/flight/fpr-search-result-components/src/FlightCard/FlightCard.tsx",
  "packages/flight/fpr-search-result-components/src/FlightCard/RoundTripAPI/FlightCard.tsx",
  "packages/flight/fpr-search-result-components/src/FlightDetailsModal/FlightDetailsCarousel.tsx",
  "packages/flight/fpr-search-result-v2/components/FlightTrayWrapper/FlightTrayWrapperProvider.tsx",
  "packages/flight/fpr-search-result-v2/components/MobileNavbar/MobileNavbar.tsx",
  "packages/flight/fpr-search-result-v2/components/MobileSearchResultList/MobileFlightList.tsx",
  ...
  "packages/flight/fpr-search-result-v2/components/SearchResultList/SearchResultList.tsx",
  "packages/flight/fpr-search-result-v2/containers/DynamicMwebProviders.tsx",
  "packages/flight/fpr-search-result-v2/containers/DynamicSearchResultProviders.tsx",
  "packages/flight/fpr-search-result-v2/hooks/useSearchResultActions.ts",
  "packages/flight/fpr-search-result-v2/hooks/useTrackingSearchResult.ts",
  "packages/flight/fpr-search-result-v2/providers/StoreRoundTripProvider.tsx",
  "packages/flight/fpr-search-result-v2/repositories/__tests__/useTrackingMap.test.ts",
  "packages/flight/fpr-search-result-v2/repositories/useTrackingMap.ts",
  "packages/flight/fpr-search-result-v2/usecases/__tests__/resolveRedirectUrls.test.ts",
  "packages/flight/fpr-search-result-v2/usecases/__tests__/useCreateFlight.test.js",
  "packages/flight/fpr-search-result-v2/usecases/resolveRedirectUrls.ts",
  "packages/flight/fpr-search-result-v2/usecases/useCreateFlight.ts",
  "packages/flight/fpr-search-result-v2/usecases/useSearchFilter.ts",
  "packages/flight/fpr-search-result/OneWay/OneWay.tsx",
  "packages/flight/fpr-search-result/TwoWay/TwoWay.tsx",
  "packages/flight/fpr-search-result/contexts/DepartureAITagContext.tsx",
  "packages/flight/fpr-search-result/hooks/__tests__/getExpectedJourneyIdCount.test.js",
  "packages/flight/fpr-search-result/hooks/useTripType.ts",
  "packages/flight/fpr-search-result/shared/useSearchResultActions.tsx",
  "packages/flight/fpr-search-result/shared/utils/crossSelling.ts"
];
 ...
 * EN Source commits: e922b71174 by Zili: [FEATURE][FLIGHT] ai tags (#33427)
 * 中文来源提交: e922b71174 by Zili: [FEATURE][FLIGHT] ai tags (#33427)
 * EN Source summary: PRD: https://traveloka.sg.larksuite.com/wiki/C5bjwJuUniW7fxkSyJelQ4skgOd | PRD (meegle): https://project.larksuite.com/fpr/6901d082e1d4ec8eeb572946/detail/11760823 | Apply all locator rules from docs/traveloka-flight-locator-guideline.md | Validate filter structure per docs/traveloka-flight-filter-structure.md | Check carry-over behavior per docs/traveloka-flight-carry-over-airline-bug-report.md | ⭐ Run P0 critical bug detection (flight flows) - powered by config/p0-detection-rules.json | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active
 * 中文来源摘要: PRD: https://traveloka.sg.larksuite.com/wiki/C5bjwJuUniW7fxkSyJelQ4skgOd | PRD (meegle): https://project.larksuite.com/fpr/6901d082e1d4ec8eeb572946/detail/11760823 | Apply all locator rules from docs/traveloka-flight-locator-guideline.md | Validate filter structure per docs/traveloka-flight-filter-structure.md | Check carry-over behavior per docs/traveloka-flight-carry-over-airline-bug-report.md | ⭐ Run P0 critical bug detection (flight flows) - powered by config/p0-detection-rules.json | Phase 2 active layer execution (weekly): npx tsx scripts/run-accumulated-cases.ts --layer active
...
test('Traveloka weekly diff generated flight results coverage (20260610)', async ({ page, ai, aiQuery }, testInfo) => {
  ...
  // EN PRD: https://traveloka.sg.larksuite.com/wiki/C5bjwJuUniW7fxkSyJelQ4skgOd
// EN PRD: https://project.larksuite.com/fpr/6901d082e1d4ec8eeb572946/detail/11760823
  try {
...
// EN PRD: https://project.larksuite.com/fpr/6901d082e1d4ec8eeb572946/detail/11760823
  ...
  // Suggested changed files (top 10 of 35): ["packages/flight/fpr-search-result-v2/components/FlightTrayWrapper/FlightTrayWrapperProvider.tsx","packages/flight/fpr-search-result-v2/components/MobileNavbar/MobileNavbar.tsx","packages/flight/fpr-search-result-v2/components/MobileSearchResultList/MobileFlightList.tsx","packages/flight/fpr-search-result-v2/components/MobileSearchResultList/MobileFlightSearchResultItem.tsx","packages/flight/fpr-search-result-v2/components/SearchResultList/FlightSectionList.tsx","packages/flight/fpr-search-result-v2/components/SearchResultList/SearchResultList.tsx","packages/flight/fpr-search-result-v2/containers/DynamicMwebProviders.tsx","packages/flight/fpr-search-result-v2/containers/DynamicSearchResultProviders.tsx","packages/flight/fpr-search-result-v2/hooks/useSearchResultActions.ts","packages/flight/fpr-search-result-v2/hooks/useTrackingSearchResult.ts"]
